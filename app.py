...
page = st.sidebar.radio(
    ...
    format_func=lambda x: {
        "Dashboard": "Dashboard",
        "Plants Tracker": "Plants Tracker",
        "Strains Library": "Strains Library",
        "Expenses": "Expenses",
        "Income": "Income",
        "Seed & Clone Stock": "Seed & Clone Stock",
...
# ===================== FOOTER =====================
st.sidebar.markdown("---")
st.sidebar.info(f"Plants: {len(st.session_state.plants)}\nStrains: {len(st.session_state.strains)}\n"
                f"Expenses: {len(st.session_state.expenses)}\nIncome: {len(st.session_state.income)}\n"
                f"Stock: {len(st.session_state.stock)}")